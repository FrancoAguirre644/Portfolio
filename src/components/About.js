...
import { MDBCardHeader, MDBBtn, MDBCard, MDBCardBody, MDBCardTitle, MDBCardText, MDBRow, MDBCol } from 'mdbreact'
                ...
                <MDBCardBody>
                    <MDBRow >
                        ...
                        <MDBCol >
                            ...
                            <hr className="hr-light w-100 green" />
                            <MDBCardText >
                    ...
                    <button class="fill text-capitalize mt-3 wow fadeIn" data-wow-iteration="1" data-wow-offset="80" data-wow-delay="1s">send</button>
                </MDBCardBody>
            </MDBCard>
        </div>
    )
